...
import MenSub1ChildComponent from './MenSub1ChildComponent'
          ...
          <div className="gap">
            <div className="title">
              ...
              <div className="right-box">
                <ul>
                  ...
                  <li className='img1'>
                    <img src="./img/HSM/men_sub1/ico_col3_off_24x24.png" alt="" />
                  </li>
                  <li className='img2'>
                    <img src="./img/HSM/men_sub1/ico_col4_on_24x24.png" alt="" />
                  </li>
                </ul>
              </div>
            </div>
            <div className="content">
              ...
              <div className="right-main">
                <MenSub1ChildComponent 샌들슬리퍼={state.샌들슬리퍼} />
              {/* <ul>
                <li>
