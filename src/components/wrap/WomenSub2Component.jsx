...
import WomenSub2ChildComponent from './WomenSub2ChildComponent'
...
export default function WomenSub1Component () {
  ...
  const getProduct=()=>{
    axios({
      url:'./data/womenSub/womenSub2.json',
      method:'GET'
    })
    .then((res)=>{
      setState({
          ...
          <div className="gap">
            <div className="title">
              ...
              <div className="right-box">
                <ul>
                  ...
                  <li className='img1'>
                    <img src="./img/HSM/women_sub2/ico_col3_off_24x24.png" alt="" />
                  </li>
                  <li className='img2'>
                    <img src="./img/HSM/women_sub2/ico_col4_on_24x24.png" alt="" />
                  </li>
                </ul>
              </div>
            </div>
            <div className="content">
              ...
              <div className="right-main">
                <WomenSub2ChildComponent 라이프스타일={state.라이프스타일} />
              {/* <ul>
                <li>
