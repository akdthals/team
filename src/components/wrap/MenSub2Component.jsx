...
import MenSub2ChildComponent from './MenSub2ChildComponent'

export default function MenSub2Component () {
          ...
          <div className="gap">
            <div className="title">
              <div className="left-box">
                <ul>
                  ...
                  <li>
                    <h3><img src="./img/HSM/men_sub1/mola.svg" alt="" /></h3> 
                  </li>
                  <li>
                    <h2>신발</h2>
                  </li>
              ...
              <div className="right-box">
                <ul>
                  ...
                  <li className='img1'>
                    <img src="./img/HSM/men_sub2/ico_col3_off_24x24.png" alt="" />
                  </li>
                  <li className='img2'>
                    <img src="./img/HSM/men_sub2/ico_col4_on_24x24.png" alt="" />
                  </li>
                </ul>
              </div>
            </div>
            <div className="content">
              ...
              <div className="right-main">
                <MenSub2ChildComponent 라이프스타일={state.라이프스타일} />
              {/* <ul>
                <li>
