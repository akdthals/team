...
import MenAllChildComponent from './MenAllChildComponent'

export default function MenAllComponent () {
          ...
          <div className="gap">
            <div className="title">
              <div className="left-box">
                <ul>
                  ...
                  <li>
                    <h3><img src="./img/HSM/men_all/mola.svg" alt="" /></h3> 
                  </li>
                  <li>
                    <h2>신발</h2>
                  </li>
            ...
            <div className="content">
              ...
              <div className="right-main">
                <MenAllChildComponent 전체보기={state.전체보기} />
              {/* <ul>
                <li>
